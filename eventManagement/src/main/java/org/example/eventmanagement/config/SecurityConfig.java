    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationProvider authenticationProvider) throws Exception {
        return http
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers("/api/v1/auth/login", "/api/v1/auth/register", "/api/v1/auth/refreshToken", "/api/v1/auth/me", "/api/v1/public/**", "/api/v1/participants/**").permitAll()
                        .requestMatchers("/api/v1/admin/**").hasAuthority("ADMIN")
                        .requestMatchers("/api/v1/user/**").hasAnyAuthority("USER", "ADMIN")
                        .requestMatchers("api/v1/clients/**").hasAnyAuthority("USER", "ADMIN")
                        ...
                        .requestMatchers("/api/v1/material/**").hasAnyAuthority("ADMIN", "USER")
                        .requestMatchers("/api/v1/events/**").hasAnyAuthority("ADMIN", "USER")
                        .requestMatchers("/api/v1/room/**").hasAnyAuthority("ADMIN","USER")
